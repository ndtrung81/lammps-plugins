...
PairLJCut2::PairLJCut2(LAMMPS *lmp) : Pair(lmp)
{
  respa_enable = 1;
...
void PairLJCut2::compute(int eflag, int vflag)
{
...
void PairLJCut2::compute_middle()
{
  int i, j, ii, jj, inum, jnum, itype, jtype;
  double xtmp, ytmp, ztmp, delx, dely, delz, fpair;
  double rsq, r2inv, r6inv, forcelj, factor_lj, rsw;
...
void PairLJCut2::compute_outer(int eflag, int vflag)
{
  int i, j, ii, jj, inum, jnum, itype, jtype;
  double xtmp, ytmp, ztmp, delx, dely, delz, evdwl, fpair;
  double rsq, r2inv, r6inv, forcelj, factor_lj, rsw;
...
void PairLJCut2::settings(int narg, char **arg)
{
...
void PairLJCut2::coeff(int narg, char **arg)
{
...
double PairLJCut2::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairLJCut2::write_restart(FILE *fp)
{
...
void PairLJCut2::read_restart(FILE *fp)
{
...
void PairLJCut2::write_restart_settings(FILE *fp)
{
...
void PairLJCut2::read_restart_settings(FILE *fp)
{
  int me = comm->me;
  if (me == 0) {
...
void PairLJCut2::write_data(FILE *fp)
{
...
void PairLJCut2::write_data_all(FILE *fp)
{
...
double PairLJCut2::single(int /*i*/, int /*j*/, int itype, int jtype, double rsq,
...
void PairLJCut2::born_matrix(int /*i*/, int /*j*/, int itype, int jtype, double rsq,
...
void *PairLJCut2::extract(const char *str, int &dim)
{
  dim = 2;
